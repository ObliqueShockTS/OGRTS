...
!  Units test for 1d-6d tensor product b-spline interpolation (with extrapolation).
    ...
    integer,parameter :: nx = 2     !! number of points in x
    integer,parameter :: ny = 2     !! number of points in y
    integer,parameter :: nz = 2     !! number of points in z
    integer,parameter :: kx = 1     !! order in x
    integer,parameter :: ky = 1     !! order in y
    integer,parameter :: kz = 1     !! order in z
